...
#define USB_DEVICE_CONFIG_TOTAL USB_DEVICE_CONFIG_HID + USB_DEVICE_CONFIG_CDC_ACM + \
    USB_DEVICE_CONFIG_MSC + USB_DEVICE_CONFIG_AUDIO + USB_DEVICE_CONFIG_PHDC + \
    USB_DEVICE_CONFIG_VIDEO + USB_DEVICE_CONFIG_CCID + USB_DEVICE_CONFIG_PRINTER + USB_DEVICE_CONFIG_DFU
/* @} */
