...
#if RTFFI_USB_VIDEO && RTFFI_USB_DISK
#define USB_INTERFACE_COUNT (4) + USB_MSC_DISK_INTERFACE_COUNT + USB_VIDEO_CAMERA_INTERFACE_COUNT
#elif RTFFI_USB_VIDEO && !RTFFI_USB_DISK
#define USB_INTERFACE_COUNT (4) + USB_VIDEO_CAMERA_INTERFACE_COUNT
#elif !RTFFI_USB_VIDEO && RTFFI_USB_DISK
#define USB_INTERFACE_COUNT (4) + USB_MSC_DISK_INTERFACE_COUNT
#else
...
#if RTFFI_USB_DISK
#define USB_VIDEO_CAMERA_CONTROL_INTERFACE_INDEX (5U)
#else
#define USB_VIDEO_CAMERA_CONTROL_INTERFACE_INDEX (4U)
#endif
#define USB_VIDEO_CAMERA_CONTROL_ENDPOINT_COUNT (1U)
#define USB_VIDEO_CAMERA_CONTROL_ENDPOINT (6U)
...
#if RTFFI_USB_DISK
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_INDEX (6U)
#else
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_INDEX (5U)
#endif
#define USB_VIDEO_CAMERA_STREAM_ENDPOINT_COUNT (1U)
#define USB_VIDEO_CAMERA_STREAM_ENDPOINT_IN (7U)
