...
usb_device_interfaces_struct_t g_cdcVcomInterfaces_2[USB_CDC_VCOM_INTERFACE_COUNT_2] = {
    {
		 ...
		 g_cdcVcomCicInterface_2,
		 sizeof(g_cdcVcomCicInterface_2) / sizeof(usb_device_interfaces_struct_t)
    },
    {
    	USB_CDC_VCOM_DIC_CLASS,
		USB_CDC_VCOM_DIC_SUBCLASS,
        ...
        g_cdcVcomDicInterface_2,
		sizeof(g_cdcVcomDicInterface_2) / sizeof(usb_device_interfaces_struct_t)},
};
...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    USB_SHORT_GET_LOW(USB_DESCRIPTOR_LENGTH_CONFIGURE +
                      (USB_IAD_DESC_SIZE + USB_DESCRIPTOR_LENGTH_INTERFACE + USB_DESCRIPTOR_LENGTH_CDC_HEADER_FUNC +
                       ...
                       USB_DESCRIPTOR_LENGTH_ENDPOINT) * 2
#if RTFFI_USB_DISK
					  ...
					  USB_VIDEO_CAMERA_VC_INPUT_TERMINAL_LENGTH +
					  USB_VIDEO_CAMERA_VC_OUTPUT_TERMINAL_LENGTH +
	...
	USB_LONG_GET_BYTE0(USB_VIDEO_CAMERA_CLOCK_FREQUENCY),
	USB_LONG_GET_BYTE1(USB_VIDEO_CAMERA_CLOCK_FREQUENCY),
	USB_LONG_GET_BYTE2(USB_VIDEO_CAMERA_CLOCK_FREQUENCY),
	USB_LONG_GET_BYTE3(USB_VIDEO_CAMERA_CLOCK_FREQUENCY),
...
|| defined(USB_DEVICE_VIDEO_CLASS_VERSION_1_5) && (USB_DEVICE_VIDEO_CLASS_VERSION_1_5 > 0U)
	...
	USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_COUNT,           /* Number of Frame Descriptors following that correspond to
															 this format */
	 /*0x7B, 0xEB, 0x36, 0xE4, 0x4F, 0x52, 0xCE, 0x11, 0x9F, 0x53, 0x00, 0x20, 0xAF, 0x0B, 0xA7,0x70, *//* GUID RGB565 E436EB7B-524F-11CE-9F53-0020AF0BA770 */
...
USB_DMA_INIT_DATA_ALIGN(USB_DATA_ALIGN_SIZE)
uint8_t g_UsbDeviceString5[] = {2U + 2U * 17U, USB_DESCRIPTOR_TYPE_STRING,
    'M',           0,
    'C',           0,
    'U',           0,
    ' ',           0,
...
uint8_t *g_UsbDeviceStringDescriptorArray[USB_DEVICE_STRING_COUNT] = {
    ...
    g_UsbDeviceString5,
#endif
	g_UsbDeviceString6, g_UsbDeviceString7
};
