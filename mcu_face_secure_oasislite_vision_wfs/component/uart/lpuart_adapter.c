...
#else
#if !(defined(UART1_BLE_SERIAL_MANAGER_BLOCKING_MODE) && (UART1_BLE_SERIAL_MANAGER_BLOCKING_MODE > 0U))
...
#else
#if !(defined(UART2_BLE_SERIAL_MANAGER_BLOCKING_MODE) && (UART2_BLE_SERIAL_MANAGER_BLOCKING_MODE > 0U))
