...
/*
 * Declare this structure global in order to allocate it in the NonCached memory
 * Higher sln_flash_mgmt layer prevent multiple invocations of this function
 * by using FreeRTOS semaphore for access control
 */
