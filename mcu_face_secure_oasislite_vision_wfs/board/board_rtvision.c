...
#endif
lpi2c_rtos_handle_t g_i2c_handle;
/*******************************************************************************
 * Code
 ******************************************************************************/
...
void BOARD_LPI2C_Init(LPI2C_Type *base, uint32_t clkSrc_Hz)
{
    ...
    if(g_i2c_handle.base == NULL)
    {
        LPI2C_MasterGetDefaultConfig(&lpi2cConfig);
        LPI2C_RTOS_Init(&g_i2c_handle, base, &lpi2cConfig, clkSrc_Hz );
                          ...
                          uint8_t txBuffSize)
{
    ...
    {
        reVal = LPI2C_RTOS_Transfer(&g_i2c_handle, &transfer);
    }
...
status_t BOARD_PCAL_I2C_Receive(
    uint8_t deviceAddress, uint32_t subAddress, uint8_t subAddressSize, uint8_t *rxBuff, uint8_t rxBuffSize)
{
    return BOARD_LPI2C_Receive(BOARD_PCAL_I2C_BASEADDR, deviceAddress, subAddress, subAddressSize, rxBuff,
                               rxBuffSize);
}
