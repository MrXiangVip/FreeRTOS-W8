...
#define SW2_GPIO_PIN 4U
#define PCAL_GPIO_PIN 13U
...
#define BOARD_PCAL_I2C_CLOCK_FREQ \
    (CLOCK_GetFreq(kCLOCK_Usb1PllClk) / 8 / (BOARD_PCAL_I2C_CLOCK_SOURCE_DIVIDER + 1U))
