...
void PeripheralEnterStopMode(void)
{
    ...
    IOMUXC_GPR->GPR4  = GPR4_STOP_REQ_BITS & ~IOMUXC_GPR_GPR4_SEMC_STOP_REQ_MASK;
    ...
    while ((IOMUXC_GPR->GPR4 & (GPR4_STOP_ACK_BITS & ~IOMUXC_GPR_GPR4_SEMC_STOP_ACK_MASK)) != (GPR4_STOP_ACK_BITS & ~IOMUXC_GPR_GPR4_SEMC_STOP_ACK_MASK))
    {
    }
