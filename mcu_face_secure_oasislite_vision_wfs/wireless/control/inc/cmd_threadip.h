...
typedef enum MAC_MacFilteringEnableRequest_MacFiltering_tag {
	...
	MAC_MacFilteringEnableRequest_MacFiltering_EnablePolicyReject = 0x01,
	MAC_MacFilteringEnableRequest_MacFiltering_EnablePolicyAccept = 0x02
...
typedef struct THR_DiagTestGetRequest_tag {
	...
	union {
		struct {
			uint8_t Value;  // IncludeTxTimestamp  // Value
