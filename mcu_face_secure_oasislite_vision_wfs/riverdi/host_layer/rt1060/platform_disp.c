...
#define DISP_LPSPI_RX_IRQn          DMA1_DMA17_IRQn

#ifdef  RTBOARD_REVC
#define DISP_LPSPI_TX_DMA_REQUEST kDmaRequestMuxLPSPI4Tx
#define DISP_LPSPI_RX_DMA_REQUEST kDmaRequestMuxLPSPI4Rx
#else
#define DISP_LPSPI_TX_DMA_REQUEST kDmaRequestMuxLPSPI3Tx
#define DISP_LPSPI_RX_DMA_REQUEST kDmaRequestMuxLPSPI3Rx
#endif
...
edma_handle_t g_lpspiDispRxEdmaHandle;
...
static void initDisplayLPSPI(uint32_t maxclk)
{
    ...
    DMAMUX_SetSource(DISP_LPSPI_DMAMUX_BASEADDR, DISP_LPSPI_RX_DMA_CHANNEL, DISP_LPSPI_RX_DMA_REQUEST);
    DMAMUX_EnableChannel(DISP_LPSPI_DMAMUX_BASEADDR, DISP_LPSPI_TX_DMA_CHANNEL);
    DMAMUX_EnableChannel(DISP_LPSPI_DMAMUX_BASEADDR, DISP_LPSPI_RX_DMA_CHANNEL);
    ...
    EDMA_CreateHandle(&g_lpspiDispRxEdmaHandle, DISP_LPSPI_DMA_BASEADDR, DISP_LPSPI_RX_DMA_CHANNEL);

    /* Create LPSPI DMA handle. */
    LPSPI_MasterTransferCreateHandleEDMA(DISP_LPSPI_MASTER_BASEADDR, &g_lpspiDispMasterEdmaHandle,
                                        DISP_LPSPI_CallbackEDMA, NULL, &g_lpspiDispRxEdmaHandle, &g_lpspiDispTxEdmaHandle);
