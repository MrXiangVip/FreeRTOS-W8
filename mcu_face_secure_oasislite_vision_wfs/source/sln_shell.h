 ...
 * Defines
 ******************************************************************************/
#define USB_SHELL_PROMPT        "cd>> "
#define USB_SHELL_PROMPT_DEBUG        "cdd>> "

#define USB_SHELL_PROMPT_INDEX 0
#define USB_SHELL_PROMPT_DEBUG_INDEX 1
