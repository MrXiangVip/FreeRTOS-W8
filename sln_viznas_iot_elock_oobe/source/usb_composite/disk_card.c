...
//                g_deviceComposite->mscDisk.readWriteError = 1;
        ...
        case kUSB_DeviceMscEventGetLbaInformation:
            ...
            lbaInformation->logicalUnitInformations[0].lengthOfEachLba = FATFS_SECTOR_SIZE;
            lbaInformation->logicalUnitInformations[0].totalLbaNumberSupports = FATFS_SECTOR_COUNT;
