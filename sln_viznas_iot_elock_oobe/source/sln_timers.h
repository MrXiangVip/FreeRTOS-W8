...
#define MS_MANUAL_REG_NO_FACE  15000 //5000  // THE TIMEOUT OF MANUAL REGISTRATION WHILE NO FACE HAS BEEN DETECTED
#define MS_MANUAL_REG_HAS_FACE 20000//15000 // THE TIMEOUT OF MANUAL REGISTRATION WHILE A FACE HAS BEEN DETECTED
#define MS_DET_NO_FACE         30000 //15000 // MS in which device will enter sleep if no face is detected while running normally
#define MS_REC_NO_FACE         50000 //25000 // MS in which device will enter sleep if a face is detected while running normally
