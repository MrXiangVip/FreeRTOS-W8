...
#define LONG_LIVE 0             // 0 下电模型 1 常供电模型
...
#define MQTTTASK_STACKSIZE 1024 //256  //(configMINIMAL_STACK_SIZE + 100)     //(configMINIMAL_STACK_SIZE + 100)
...
#define UART5SYNCTASK_PRIORITY (configMAX_PRIORITIES - 1)
#define UART5SYNCTASK_STACKSIZE  (configMINIMAL_STACK_SIZE + 100)

#define UART5QMSGTASK_PRIORITY (configMAX_PRIORITIES - 1)
#define UART5QMSGTASK_STACKSIZE  (configMINIMAL_STACK_SIZE + 500)

#define UART5LOOPTASK_PRIORITY (configMAX_PRIORITIES - 3)
#define UART5LOOPTASK_STACKSIZE  (configMINIMAL_STACK_SIZE + 100)

#define UART8RECVTASK_PRIORITY (configMAX_PRIORITIES - 2UL) 
#define UART8RECVTASK_STACKSIZE   2048	//2048	//1024

#define UART8MSGHANDLETASK_PRIORITY (configMAX_PRIORITIES - 4)
#define UART8MSGHANDLETASK_STACKSIZE 3072	//2048	//1024

#define UART8SENDHEARTBEATTASK_PRIORITY (configMAX_PRIORITIES - 2)
#define UART8SENDHEARTBEATTASK_STACKSIZE 1024	//2048	//1024

#define UART8UPLOADDATATASK_PRIORITY (configMAX_PRIORITIES - 2)
#define UART8UPLOADDATATASK_STACKSIZE 3072	//2048	//1024

#define TESTTASK_PRIORITY (configMAX_PRIORITIES - 2)
#define TESTTASK_STACKSIZE 1024	//2048	//1024
...
#define FACEREC_FS_MAP_ADDR  (0xB00000U) //xshx mod 20220831
#endif
