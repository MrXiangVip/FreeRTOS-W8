...
#define USB_INTERFACE_COUNT_USB         (USB_CDC_VCOM_INTERFACE_COUNT + USB_VIDEO_CAMERA_INTERFACE_COUNT)
#define USB_INTERFACE_COUNT_LCD         (USB_CDC_VCOM_INTERFACE_COUNT)
#define USB_INTERFACE_COUNT_MSC_LCD     (USB_CDC_VCOM_INTERFACE_COUNT + USB_MSC_DISK_INTERFACE_COUNT)
#define USB_INTERFACE_COUNT         (Cfg_AppDataGetOutputMode() ? USB_INTERFACE_COUNT_MSC_LCD : USB_INTERFACE_COUNT_USB)
...
#define USB_DESCRIPTOR_LENGTH_STRING7 (sizeof(g_UsbDeviceString7))
...
#define USB_MSC_DISK_INTERFACE_INDEX (4)
#define USB_MSC_DISK_ENDPOINT_COUNT (2)
#define USB_MSC_DISK_BULK_IN_ENDPOINT (5)
#define USB_MSC_DISK_BULK_OUT_ENDPOINT (5)
...
#define USB_VIDEO_CAMERA_CONTROL_INTERFACE_INDEX (2U)
#define USB_VIDEO_CAMERA_CONTROL_ENDPOINT_COUNT  (1U)
#define USB_VIDEO_CAMERA_CONTROL_ENDPOINT        (4U)
...
#define USB_VIDEO_CAMERA_STREAM_INTERFACE_INDEX    (3U)
#define USB_VIDEO_CAMERA_STREAM_ENDPOINT_COUNT     (1U)
#define USB_VIDEO_CAMERA_STREAM_ENDPOINT_IN        (3U)
...
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_DATA_BITS (CAMERA_BYTES_PER_PIXEL) /*ALEX*/
...
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_30FPS (10000000U / 10U)
#define USB_VIDEO_CAMERA_UNCOMPRESSED_FRAME_INTERVAL_10FPS (10000000U / 5U)
