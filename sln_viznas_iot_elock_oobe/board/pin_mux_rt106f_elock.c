...
void BOARD_InitLPUART8Pins(void)
{
	  ...
	  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_SD_B0_04_LPUART8_TX,        /* GPIO_AD_B0_12 is configured as LPUART1_TX */
	      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
	  IOMUXC_SetPinMux(
			  IOMUXC_GPIO_SD_B0_05_LPUART8_RX,        /* GPIO_AD_B0_13 is configured as LPUART1_RX */
	      0U);                                    /* Software Input On Field: Input Path is determined by functionality */
	  IOMUXC_SetPinConfig(
...
void BOARD_InitCSIPins(void)
{
    ...
    //3D WAK
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B1_02_GPIO3_IO02,          /* 3D WAK is configured as GPIO3_IO02 */
        0U);
    //3D RST
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_SD_B1_03_GPIO3_IO03,          /* 3D RST is configured as GPIO3_IO03 */
        0U);
#endif

    //RGB PWR_DWN1
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_B1_15_GPIO2_IO31,           /* GPIO_B1_15 is configured as RGB Camera PWDN_1 GPIO2_IO31 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    //IR_PWD2
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_B1_14_GPIO2_IO30,           /* GPIO_B1_14 is configured as IR Camera PWDN_2 GPIO2_IO30 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */


    //I2C1 Use for Camera RGB
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_B1_00_LPI2C1_SCL,        /* GPIO_AD_B1_00 is configured as LPI2C1_SCL */
        1U);                                    /* Software Input On Field: Force input path of pad GPIO_AD_B1_00 */
    IOMUXC_SetPinMux(
    ...
    //Analog switch use for select I2C4/UART1
    IOMUXC_SetPinMux(
        IOMUXC_GPIO_AD_B0_00_GPIO1_IO00,           /*GPIO_AD_B0_00 is configured as GPIO2_IO26 */
        0U);                                    /*Software Input On Field: Input Path is determined by functionality */

    //I2C4 Use for Camera IR
    IOMUXC_SetPinMux(
    ...
    gpio_pin_config_t i2c_switch_config = {
      .direction = kGPIO_DigitalOutput,
      .outputLogic = 1U,
      .interruptMode = kGPIO_NoIntmode
    };
    /* Initialize GPIO functionality on GPIO_B1_10 (pin B13) */
    GPIO_PinInit(GPIO1, 0U, &i2c_switch_config);
...
void LPSPI4_InitPins(void)
{
    ...
    IOMUXC_SetPinMux(
            IOMUXC_GPIO_B1_04_LPSPI4_PCS0,       /* GPIO_B0_00 is configured as LPSPI4_PCS0 */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinMux(
            IOMUXC_GPIO_B1_05_LPSPI4_SDI,        /* GPIO_B0_01 is configured as LPSPI4_SDI */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinMux(
            IOMUXC_GPIO_B1_06_LPSPI4_SDO,        /* GPIO_B0_02 is configured as LPSPI4_SDO */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinMux(
            IOMUXC_GPIO_B1_07_LPSPI4_SCK,        /* GPIO_B0_03 is configured as LPSPI4_SCK */
        0U);                                    /* Software Input On Field: Input Path is determined by functionality */
    IOMUXC_SetPinConfig(
            IOMUXC_GPIO_B1_04_LPSPI4_PCS0,       /* GPIO_B0_00 PAD functional properties : */
        0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinConfig(
            IOMUXC_GPIO_B1_05_LPSPI4_SDI,        /* GPIO_B0_01 PAD functional properties : */
        0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinConfig(
            IOMUXC_GPIO_B1_06_LPSPI4_SDO,        /* GPIO_B0_02 PAD functional properties : */
        0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
                                                   ...
                                                   Hyst. Enable Field: Hysteresis Disabled */
    IOMUXC_SetPinConfig(
            IOMUXC_GPIO_B1_07_LPSPI4_SCK,        /* GPIO_B0_03 PAD functional properties : */
        0x10B0u);                               /* Slew Rate Field: Slow Slew Rate
                                                   Drive Strength Field: R0/6
                                                   Speed Field: medium(100MHz)
                                                   Open Drain Enable Field: Open Drain Disabled
...
void BOARD_IniteLockDispPins(void)
{
    ...
    //SDA                                        
    IOMUXC_SetPinConfig(
        IOMUXC_GPIO_B1_06_GPIO2_IO22,             /* GPIO_B1_06 PAD functional properties : */
        0x90A0U);                                 /* Slew Rate Field: Slow Slew Rate
                                                Drive Strength Field: R0/4
                                                Speed Field: medium(100MHz)
                                                Open Drain Enable Field: Open Drain Disabled
    ...
    /* GPIO configuration on GPIO_AD_B0_08 (pin H08) */
    gpio_pin_config_t gpio_pin_config = {
        .direction = kGPIO_DigitalOutput,
        .outputLogic = 1U,
        .interruptMode = kGPIO_NoIntmode
    };
    /* Initialize GPIO functionality on GPIO_B1_07 (pin E23) SCL */
    GPIO_PinInit(GPIO2, 23U, &gpio_pin_config);

    /* Initialize GPIO functionality on GPIO_B1_06 (pin D22) SDA */
    GPIO_PinInit(GPIO2, 22U, &gpio_pin_config);

    /* Initialize GPIO functionality on GPIO_B1_04 (pin C7) CS*/
    GPIO_PinInit(GPIO2, 20U, &gpio_pin_config);

    /* Initialize GPIO functionality on GPIO_AD_B0_08 (pin H08) RST*/
    GPIO_PinInit(GPIO1, 8U, &gpio_pin_config);

    /* Initialize GPIO functionality on GPIO_B1_10 (pin B13) PWR*/
    GPIO_PinInit(GPIO2, 26U, &gpio_pin_config);

    /* Initialize GPIO functionality on GPIO_EMC_40 (pin M3) BL_EN*/
    GPIO_PinInit(GPIO3, 26U, &gpio_pin_config);
